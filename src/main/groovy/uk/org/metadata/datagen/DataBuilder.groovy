...
class DataBuilder {
    ...
    static void buildRareDiseaseRegAndPhenotypeDataset(String filename,int numberOfRows,int numberOfRowsFalseData){
        ...
        def col1 = new DataItem("Cohort Person Number", "[0-9]{9}" )
        ...
        def col11 = new DataItem("Local Case Identifer", "[a-zA-Z\\ _']{1,20}")
        ...
        def col15 = new DataItem("Person Taking Consent", "[a-zA-Z\\ _']{1,20}")
        ...
        col13.generateChoices(numberOfRows,numberOfRowsFalseData)
        col14.generateDates(numberOfRows,numberOfRowsFalseData)
        col15.generateItems(numberOfRows,numberOfRowsFalseData)
        ...
        def col27 = new DataItem("Other Biological Relationship to Proband *","[a-zA-Z\\ _']{1,20}")
        def col28 = new DataItem("Full Name of Responsible Consultant *","[a-zA-Z\\ _']{1,50}")
        def col29 = new DataItem("Mothers Ethnic Origin *", rds.Ethnicity)
        def col30 = new DataItem("Mothers Ethnic Origin Other","[a-zA-Z\\ _']{1,50}")
        ...
        def col31 = new DataItem("Mothers Other Relevant Ancestry","[a-zA-Z\\ _']{1,50}")
        def col32 = new DataItem("Fathers Ethnic Origin *", rds.Ethnicity)
        def col33 = new DataItem("Fathers Ethnic Origin Other","[a-zA-Z\\ _']{1,50}")
        def col34= new DataItem("Fathers Other Relevant Ancestry","[a-zA-Z\\ _']{1,50}")
